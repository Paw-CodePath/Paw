...
public abstract class FirestoreModel {
    ...
    protected static <T extends FirestoreModel> ListenerRegistration observeAll(Class<T> cls, Query query, ListObserver<T> observer) {
        return getQueryController(cls).observeAll(query, observer);
    }
